...
import { FaTimes, FaStar, FaHotel, FaThumbsUp } from 'react-icons/fa';
...
/**
 * HotelReviewsModal — lists guest reviews for a hotel with aggregate stats.
 */
const HotelReviewsModal = ({ isOpen, onClose, hotel }) => {
  ...
  const fetchReviews = async () => {
    ...
    try {
      const [revRes, statRes] = await Promise.all([
        axios.get(`${API_BASE}/api/reviews/hotel/${hotelId}`),
        axios.get(`${API_BASE}/api/reviews/hotel/${hotelId}/stats`),
      ]);
            ...
            >
              ...
              <div className="flex items-center justify-between p-5 border-b shrink-0">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h2 className="font-bold text-gray-800">Guest Reviews</h2>
